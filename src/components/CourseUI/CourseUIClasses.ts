export const courseUIClasses = {
  card: "shadow-lg border border-gray-400 rounded-lg p-4 sm:p-6 m-2 sm:m-4 bg-white transition-colors duration-200 ease-in-out w-full sm:min-w-[95%] max-w-full",
