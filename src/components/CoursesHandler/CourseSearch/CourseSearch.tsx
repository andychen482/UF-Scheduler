...
const CourseSearch: React.FC<CourseSearchProps> = ({
  ...
  return (
    <input
      type="text"
      placeholder="Select your completed classes..."
      value={searchTerm}
      onChange={handleSearchChange}
      autoCorrect="off"
      className="px-2 py-2 text-black bg-gray-200 rounded-md placeholder-gray-500 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 transition-colors duration-500 w-[18rem] sm:w-[20rem] md:w-[24rem] lg:w-[28rem] xl:w-[32rem]"
    />
  );
};
